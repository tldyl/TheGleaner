...
public class Nocturne : CustomCardModel {
	...
	protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay) {
		await PowerCmd.Apply<NocturnePower>(choiceContext, Owner.Creature, DynamicVars["StrAmount"].BaseValue, Owner.Creature, null);
		await PowerCmd.Apply<DemoTempDexterityPower>(choiceContext, Owner.Creature, DynamicVars["DexAmount"].BaseValue, Owner.Creature, null);
	}
