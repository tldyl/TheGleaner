...
public class ArbiterOfFocus : CustomCardModel, IChoosable {
    //public override string PortraitPath => $"res://TheGleaner/images/cards/{Id.Entry.ToLowerInvariant()}.png";

    public ArbiterOfFocus() : base(-1, CardType.Skill, CardRarity.Common, TargetType.None) {
