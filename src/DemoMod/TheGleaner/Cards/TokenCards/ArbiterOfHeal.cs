...
public class ArbiterOfHeal : CustomCardModel, IChoosable {
    //public override string PortraitPath => $"res://TheGleaner/images/cards/{Id.Entry.ToLowerInvariant()}.png";

    public ArbiterOfHeal() : base(-1, CardType.Skill, CardRarity.Common, TargetType.None) {
