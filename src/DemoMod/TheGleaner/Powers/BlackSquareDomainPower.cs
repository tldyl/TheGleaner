...
public class BlackSquareDomainPower : CustomPowerModel {
    private const string PowerIconPath = "res://TheGleaner/images/powers/demomod-black_square_domain_power.png";
